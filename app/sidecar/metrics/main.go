...
import (
	...
	"github.com/cravtos/asperitas-backend/app/sidecar/metrics/collector"
	"github.com/cravtos/asperitas-backend/app/sidecar/metrics/publisher"
	"github.com/cravtos/asperitas-backend/app/sidecar/metrics/publisher/expvar"
...
func run(log *log.Logger) error {
	...
	var cfg struct {
		...
		Collect struct {
			From string `conf:"default:http://asperitas-api:4000/debug/vars"`
		}
		Publish struct {
